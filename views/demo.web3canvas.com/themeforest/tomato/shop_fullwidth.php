                                ...
                                foreach ($plats as $plat) {
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="product-info">
                                            ...
                                            <h4><a href="recipe_detail-image.html"><?php echo $plat['nom'] ?></a></h4>
                                            ...
                                            <div class="product-price"><?php echo $plat['prix'] ?></div>
                                            <div class="shop-meta">
                                                <form class="shop-meta" method="POST">


                                                    <input name="idproduit" value="<?php echo $plat['id'] ?>" hidden>
                                                    <input name="nom" value="<?php echo $plat['nom'] ?>" hidden>
                                                    <input name="prix" value="<?php echo $plat['prix'] ?>" hidden>
