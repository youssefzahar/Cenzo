...
if (isset($_POST['sumbitcommande'])) {
    ...
    $idc=time();//id unique :
    $commande = new commande($idc,1, $q, $_SESSION['sum'], date("Y/m/d"), "en cours de validation");
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand"  href="index.html">
                        <img src="img/cenzo.png" alt="nav-logo" width="200px" height="150px">
                    </a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="shop_fullwidth.php" class="dropdown-toggle" data-toggle="dropdown" role="button"
                               aria-haspopup="true" aria-expanded="false">Shop<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="shop_fullwidth.php">Shop </a></li>
                            </ul>
                        </li>
                                ...
                                <td colspan="6" class="actions">
                                    ...
                                    <div class="col-md-6">
                                        <div class="cart-btn">
                                            ...
                                            <form method="POST">
                                                <button class="btn btn-danger"  name="emptycart" type="submit">Empty the cart</button>
                                                <button class="btn btn-success" type="submit" name="sumbitcommande"
                        ...
                        <div class="cart_totals">
                            <div class="col-md-6 push-md-6 no-padding">
                                ...
                                <table class="table table-bordered col-md-6">
                                    ...
                                    <tr>
                                        <th>Order Total</th>
                                        <td><strong><span class="amount"><?= $_SESSION['sum'] ?> TND</span></strong></td>
                                    </tr>
                                    </tbody>
                                            <!-- --------------------------------------------------------- -->
