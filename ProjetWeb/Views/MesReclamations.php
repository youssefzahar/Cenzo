...
$liste=$reclamationC->afficherMesReclamationCom($_SESSION['idclient']);
...
<h2 class="text-uppercase">Reclamations</h2>
</div>
</div>
</div>
</section>
...
<tbody>
					...
					<td>
					<form method="POST" action="ModifierReclamation.php?id=<?PHP echo $row['id']; ?>">
