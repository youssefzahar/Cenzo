...
$forumC= new ForumC();
if (isset($_GET['id'])){
$result=$forumC->recupererForum($_GET['id']);
...
$forumC->modifierForum($forum,$_GET['id']);
...
<div class="form-group">
                  ...
                  <select class="selectpicker" name="categorie">
                    <option value="<?PHP echo $categorie ?>">Selectionner une categorie</option>
...
<div class="form-group">
<input class="form-control" placeholder="Subject" type="text" id="sujet" name="sujet" value="<?PHP echo $sujet ?>">
</div>
<div class="form-group">
<textarea class="form-control" name="description" id="description" placeholder="Description" rows="5" value="<?PHP echo $description ?>"><?PHP echo $description ?></textarea>
</div>
<input class="btn btn-default btn-lg btn-block" type="submit" value="Modifier" name="Modifier" id="Modifier">
