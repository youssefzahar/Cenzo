...
<h4><a href="AfficherForum.php?categorie=<?php echo $row['categorie']; ?>"><?php echo $row['categorie']; ?></a></h4>
</div>
<div class="col-md-5 col-sm-5">
<div class="post-date"><?php echo $row['date_creation']; ?></div>
</div>
</div>
<hr>
<a href="AfficherForum.php?categorie=<?php echo $row['categorie']; ?>" class="btn btn-default">Voir plus</a>
</article>
                    <?php 
                    }
                    ?>  
