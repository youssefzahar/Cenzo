...
<!-- Mirrored from demo.web3canvas.com/themeforest/tomato/recipe.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Apr 2021 14:18:39 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="recipe.php" class="dropdown-toggle" data-toggle="dropdown" role="button"
                               aria-haspopup="true" aria-expanded="false">Recipe<span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="recipe.php">Recipe - 2Col</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="shop_cart.php">Shop - Cart</a></li>
                        ...
                        <li class="dropdown">
                            <a class="css-pointer dropdown-toggle" data-toggle="dropdown" role="button"
                               aria-haspopup="true" aria-expanded="false"><i
                                        class="fa fa-shopping-cart fsc pull-left"></i><span class="cart-number">3</span><span
                                        class="caret"></span></a>
                            <div class="cart-content dropdown-menu">
                                ...
                                <div class="cart-items">
                                    ...
                                    <div class="cart-item clearfix">
                                        <div class="cart-item-image">
                                            <a href="shop_single_full.html"><img src="img/cart-img2.jpg"
                                                                                 alt="Chicken stew"></a>
                                        </div>
                                        <div class="cart-item-desc">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="rc-info">
                            ...
                            <a href="recipe_detail-image.html" class="btn btn-default" disabled>View Details</a>
                        </div>
                    </div>
                    <br>
                    <?php
                    ...
                    <div class="col-md-4  col-sm-6">
                        ...
                        <div class="footer-address">
                            ...
                            <p><i class="fa fa-envelope-o"></i><a
                                        ...
                                        class="__cf_email__"
                                        data-cfemail="4c3f393c3c233e380c3e293f382d393e2d2238622f2321">[email&#160;protected]</a>
                            </p>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from demo.web3canvas.com/themeforest/tomato/recipe.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Apr 2021 14:18:42 GMT -->
</html>
