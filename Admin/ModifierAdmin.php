              ...
              <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        <label>Nom</label>
                        <input type="text" class="form-control" placeholder="Nom" name="nomuser"  value="<?PHP echo $nom ?>">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="*****" name="mdp" value="">
                      </div>
                    </div>
                    <div class="col-md-6 pl-1">
                      <div class="form-group">
                        <label>Telephone</label>
                        <input type="text" class="form-control" placeholder="Telephone" name="tel" value="<?PHP echo $tel ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  <label class="col-md-3 control-label">Image</label>
                     <div >
                      <div class="col-12">
                        <input class="btn" input type="file" name="image" value="<?PHP echo $image ?>" >
                      </div>
                      </div>
                  </div>
